...
def build_splits() -> None:
    ...
    cid_2_samp_idxs = {cid: list(sorted(img_ptrs[cid].keys())) for cid in cids}
    ...
    data_indexes = build_data_indexes_bryo(cids, skeys_pts, cid2enc, img_ptrs=img_ptrs)
    data_indexes_dev = build_data_indexes_bryo(cids, skeys_pts_dev, cid2enc, img_ptrs=img_ptrs)
