...
# ], dtype=torch.float32)
# labels_enc_imgs = torch.tensor([0, 1, 1, 0, 1, 0, 2], dtype=torch.long)
...
# ], dtype=torch.float32)
# labels_enc_txts = torch.tensor([0, 1, 2])
...
map_score = compute_map_txt2img(embs_txts, labels_enc_txts, embs_imgs, labels_enc_imgs)
