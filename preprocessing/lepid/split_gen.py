...
from preprocessing.lepid.split_gen_utils import (
    build_data_indexes,
    build_img_ptrs,
...
def build_splits():
    ...
    cid_2_family = {cid: class_data[cid]["family"] for cid in cids}
    ...
    cid_2_family = {cid: cid_2_family[cid] for cid in cids}  # filter cids
    ...
    data_indexes_dev = build_data_indexes(
        cids,
        skeys_pts_dev,
        cid_2_family,
        cid2enc,
    ...
    generate_partition_summary_table(
        ...
        title="Lepidoptera Partition Summary",
    )
