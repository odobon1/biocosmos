...
from preprocessing.bryo.split_gen_utils import build_img_ptrs

import pdb


def build_splits() -> None:
    GenSplitDataManager.setup("bryo")
    ...
    cid_2_penult = {cid: GenSplitDataManager.class_data[cid]["family"] for cid in cids}
