...
on the campaign launch path (frozen cfg_baseline.json snapshot + the coord's overrides.json, arm + coord
overrides merged) to recover samps_per_epoch (the plots' epoch axis) and the split whose n-shot bucket names
label the n-shot panels. Trials without a data_trial.pkl (never checkpointed) are skipped.
"""
