...
from utils.config import get_config_hardware, get_config_train, load_train_config_dict
...
def test_get_config_train_loads_repo_configs(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    cfg_dict.update({"campaign": "test", "phase": "screening", "arm": "test", "coord": "test", "seed": 42, "dataset": "bryo"})
